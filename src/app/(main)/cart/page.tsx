                ...
                <div className="flex items-center justify-between mt-3">
                  {item.isMeter ? (
                    <div className="text-sm text-gray-500">
                      جمع: <span className="font-bold text-blue-600">{formatPrice(item.price * (item.quantity || 1) * (item.branchCount || 1) * ((item.branchLength || 400) / 100))}</span>
                    </div>
                  ) : (
                  ...
                  <div className="flex items-center gap-4">
                    <span className="font-bold">{item.isMeter ? formatPrice(item.price * (item.quantity || 1) * (item.branchCount || 1) * ((item.branchLength || 400) / 100)) : formatPrice(item.price * item.quantity)}</span>
